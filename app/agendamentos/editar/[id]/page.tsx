...
export default function EditarAgendamento({ params }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const agendamentoSnapshot = await get(agendamentoRef)
        ...
        setFormData({
          ...
          tipo: agendamentoData.tipo || "Transporte",
          status: agendamentoData.status || "Agendado",
          veiculoId: agendamentoData.veiculoId || "",
          data: dataHora,
          hora: hora,
          responsavel: agendamentoData.responsavel || "",
          local: agendamentoData.local || "",
          prioridade: agendamentoData.prioridade || "Normal",
        })
      } catch (error) {
