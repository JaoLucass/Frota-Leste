...
export default function EditarAbastecimento({ params }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const abastecimentoSnapshot = await get(abastecimentoRef)

        if (!abastecimentoSnapshot.exists()) {
          toast({
            variant: "destructive",
            title: "Erro!",
        ...
        setFormData({
          veiculoId: abastecimentoData.veiculoId || "",
          data: abastecimentoData.data ? new Date(abastecimentoData.data) : new Date(),
          posto: abastecimentoData.posto || "",
          litros: abastecimentoData.litros?.toString() || "",
          valor: abastecimentoData.valor?.toString() || "",
          kmAtual: abastecimentoData.kmAtual?.toString() || "",
          tipoCombustivel: abastecimentoData.tipoCombustivel || "Gasolina",
          observacoes: abastecimentoData.observacoes || "",
        })

        setKmAnterior(abastecimentoData.kmAnterior)
      } catch (error) {
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Editar Abastecimento</h1>
      </div>
